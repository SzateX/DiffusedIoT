...
handler500 = 'MQTTApi.views.handler500'
...
urlpatterns = [
    ...
    url(r'^dashboard/hub/(?P<hub>\d+)/device/(?P<pk>\d+)/delete/$', v.DeleteDeviceView.as_view(), name='hub_devices_delete'),
    ...
    url(r'^dashboard/hub/(?P<hub>\d+)/device/(?P<device>\d+)/units/(?P<pk>\d+)/data/$', v.UnitDataView.as_view(), name='unit_data'),
    ...
    url(r'^dashboard/hub/(?P<hub>\d+)/device/(?P<device>\d+)/units/(?P<unit>\d+)/connected_units/(?P<pk>\d+)/delete/$', v.DeleteConnectedUnitView.as_view(), name='connected_unit_delete'),
