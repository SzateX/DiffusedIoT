"""
Django settings for MQTTHub project.
...
WSGI_APPLICATION = 'MQTTHub.wsgi.application'
...
HUB_ID = 1
API_KEY = '6srjeRxV.492Us8hDpYtDPcNJgCpcgfN04eQo08bT'
